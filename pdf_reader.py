...
llm = ChatOpenAI(
    ...
    timeout=None,
    max_retries=2,
    api_key="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",
    # base_url="...",
    # organization="...",
    # other params...
)
